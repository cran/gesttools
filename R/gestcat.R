...
#'
#' @details Suppose a set of time varying confounders \eqn{L_t}, and a time-varying categorical exposure variable \eqn{A_t}, measured over time periods \eqn{t=1,\ldots,T}, with an end of study outcome \eqn{Y} measured at time \eqn{T+1}.
